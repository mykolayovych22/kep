          ...
          <ul class="nav-links">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a href="pages/about/history">Історія коледжу</a></li>
                <li><a href="pages/about/defenders">Пам'яті Захисників України</a></li>
                <li><a href="pages/about/administration">Дирекція</a></li>
                <li><a href="pages/about/department">Відділення</a></li>
                <li><a href="pages/about/cyclical_commissions">Циклові комісії</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="pages/public/votes">Вибори директора</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <span
              ...
              ></span>
              <ul class="dropdown-menu">
                <li><a href="edu_activity_sub_pages/psychologist">Методична рада</a></li>
                <li><a href="edu_activity_sub_pages/activity_clubs">Виховна діяльність</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="pages/teacher/qualification">Підвищення кваліфікації</a></li>
              </ul>
            </li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="pages/student/catalog">Каталог дисциплін вільного вибору</a></li>
                <li><a href="pages/student/believe">Скринька довіри</a></li>
                <li><a href="pages/student/schedule">Розклад пар</a></li>
              </ul>
            </li>
            <li class="dropdown">
              <span>Вступнику <i class="fa-solid fa-chevron-down"></i></span>
              <ul class="dropdown-menu">
                <li><a href="pages/entrant/regular_framework">Нормативно-правова база</a></li>
                <li><a href="#">Протоколи</a></li>
                <li><a href="pages/entrant/rating">Рейтингові списки</a></li>
                <li><a href="#">Інформація про вступ</a></li>
                <li><a href="pages/entrant/courses">Підготовчі курси</a></li>
                <li><a href="pages/entrant/specialty">Спеціальності</a></li>
              </ul>
            </li>
            <li><a href="pages/library/library">Бібліотека</a></li>
          </ul>
          <div>
